...
*   **Project** (referred to as either "the Project", "We", "Us" or "Our" in this Disclaimer) refers to chat-test-nine-psi.
*   **Service** refers to the Website.
*   **You** means the individual accessing the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
*   **Website** refers to chat-test-nine-psi, accessible from [https://chat-test-nine-psi.vercel.app](https://chat-test-nine-psi.vercel.app)
