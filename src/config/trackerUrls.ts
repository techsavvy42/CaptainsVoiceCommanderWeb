let trackerUrls: string[] | undefined = [
  // If you would like to host your own Captains Voice Commander instance with alternative
...
// when using the `npm run dev` script. If you are hosting your own Captains Voice Commander
